 ...
 * @author pckid
 */
public class CombinedNoveltyBasedSelector<TSentenceType,TTokenType> implements
    ...
    public CombinedNoveltyBasedSelector() {
    ...
    public CombinedNoveltyBasedSelector(int iMinNGram, int iMaxNGram, int iDist) {
        // PreexistingInfo = new DocumentNGramSymWinGraph();
        Comparator = new NGramCachedGraphComparator();
        SentenceRepresentationFilter = new
                IdentityObjectFilter<DocumentNGramGraph>();
    ...
    public CombinedNoveltyBasedSelector(String sPreexistingText) {
        // PreexistingInfo = new DocumentNGramSymWinGraph();
        initComparator();
        SentenceRepresentationFilter = new
                IdentityObjectFilter<DocumentNGramGraph>();
    ...
    public CombinedNoveltyBasedSelector(String sPreexistingText, int iMinNGram,
        ...
        while ((!Sentences.isEmpty()) && (alRes.size() < MaxSentencesSelected)){
            ...
            for (TSentenceType s : Sentences) {
                ...
                try {
                    ...
                    Logger.getLogger(CombinedNoveltyBasedSelector.class.getName()).log(Level.SEVERE,
                            null, ex);
                }
    ...
    public List<TSentenceType> selectFromSentences(List<TSentenceType> sSentences) {
        ...
        while ((!Sentences.isEmpty()) && (alRes.size() < MaxSentencesSelected)){
            ...
            while (!redundancy.asTreeMap().isEmpty()) {
                ...
                // Decrease original rank by redundancy rank
